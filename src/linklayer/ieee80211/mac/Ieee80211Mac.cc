...
void Ieee80211Mac::configureAutoBitRate()
{
    ...
    case 4:
        rateControlMode = RATE_ACARS;
        acars_bitrateadaptation = new ACARS(opMode);
        EV<<"MAC Transmission algorithm : ACARS Rate"  <<endl;
        break;
    case 5:
...
void Ieee80211Mac::handleLowerMsg(cPacket *msg)
{
    ...
    else //Others Adaptation Rate
    {
        checkBitRateAdaptation(_snr);
    }
...
/**
 * Funci�n para los algoritmos AARF y ARF
 */
 ...
 */
void Ieee80211Mac::checkBitRateAdaptation(double in_snr)
{
